...
<form accept-charset="UTF-8" id="form1" method="post" style="margin-bottom: 0;" enctype="multipart/form-data">
	<div class="main_title">公共统计规则文件上传</div>
	
	<div class="container">
		<div class="list_container">
			<div class="table_container_title">公共统计规则文件上传</div>
...
function _upload() {
	   ...
	   parent.win.confirm('确定要导入吗？',function(r) {
			if (r) {	
				...
				var url = '${pageContext.request.contextPath}/publicsta/inport';
				$.ajax({
					type : 'post',
					url : url,
					dataType : 'json',
