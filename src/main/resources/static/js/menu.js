$(document).ready(function() {
	...
	$("li.nav-item-1").click(function() {
		$(this).addClass("active");
		$(this).siblings("li.nav-item-1").removeClass("active");
		$(this).parent("ul").parent("li.nav-item").siblings("li.nav-item").children("ul.sub-menu").children("li.nav-item-1").removeClass("active");
	});
	//wym,由于菜单在点击的时候，没有判断是从哪里触发的事件，所以点击下方的子超链接的时候，就会导致不能触发外层的点击时的高亮效果
	$("ul.page-sidebar-menu.page-header-fixed > li.nav-item > ul").click(function(e) {
		$(this).parent("li.nav-item").addClass("active", "open");
		$(this).parent("li.nav-item").siblings("li.nav-item").removeClass("active", "open");
	});
